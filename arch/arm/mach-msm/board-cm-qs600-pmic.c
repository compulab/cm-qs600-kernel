...
static struct pm8xxx_gpio_init pm8921_gpios[] __initdata = {
	...
	PM8921_GPIO_INPUT(19, PM_GPIO_PULL_UP_1P5), /* WLAN/BT: BT_WKUP_HOST */
	PM8921_GPIO_INPUT(42, PM_GPIO_PULL_UP_1P5), /* WLAN/BT: WAKE_ON_WLAN */
	PM8921_GPIO_OUTPUT(43, 0, MED),		/* WLAN/BT: WLAN_PWD_L */
	PM8921_GPIO_OUTPUT(44, 0, MED),		/* WLAN/BT: BT_PWD_L */
};
